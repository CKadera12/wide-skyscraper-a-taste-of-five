...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[0,0,160,600],[324,192,119,132],[445,192,35,159],[324,326,81,145],[162,0,160,600],[324,0,160,190]]}
];
...
(lib.skyscraperatasteoftrace = function() {
...
(lib.wideskyscraperatasteoffive = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(60).to({startPosition:0},0).to({alpha:1},10).wait(116));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(67).to({startPosition:0},0).to({alpha:1},10).wait(109));
	...
	// trace
	this.instance_16 = new lib.skyscraperatasteoftrace();
	this.instance_16.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(186));

	// table
	this.instance_17 = new lib.skyscrapertableatasteof();
	this.instance_17.parent = this;
	this.instance_17.setTransform(80,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(186));
