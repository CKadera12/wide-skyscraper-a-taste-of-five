...
(lib.wideskyscraperatasteoffive = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("AqLPuIAAnMIXrAAIAAHMg");
	mask.setTransform(86.4,100.6);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(9).to({y:143.5},0).to({y:173.5,alpha:1},10,cjs.Ease.get(1)).to({y:163.5},6,cjs.Ease.get(1)).wait(161));

	// mask (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("AolTDIAAvbIUfAAIAAPbg");
	mask_1.setTransform(76.2,121.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(9).to({y:165.2},0).to({y:195.2,alpha:1},10,cjs.Ease.get(1)).to({y:185.2},6,cjs.Ease.get(1)).wait(161));
